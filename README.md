...
Понятие веб-технологий. Чем веб отличается от других сетевых служб?
Основные сетевые протоколы, использующиеся в вебе.
История развития веб-технологий.
Клиентская часть веб-приложений. Назначение, технологии, схема работы.
Серверная часть веб-приложений. Назначение, технологии, схема работы.
Необходимое программное обеспечения для работы веб-приложений.
Необходимое программное обеспечение для веб-разработки.
URL и URI. Понятие, различия, структура, примеры, использование.
Схема соединения по протоколу HTTP.
HTTP-запросы. Структура, примеры, использование, методы.
HTTP-ответы. Структура, примеры, поля ответа, использование.
 Методы HTTP. Использование в современных API.
Общая характеристика языка HTML. Назначение, структура. Понятие тега. Виды тегов.
HTML5. Особенности, примеры тегов, назначение. Понятие семантических элементов.
HTML. Теги заголовка веб-страницы.
HTML. Теги форматирования текста.
HTML. Встроенные и блочные элементы.
HTML. Теги форматирования списков.
HTML. Таблицы.
HTML. Гиперссылки и якоря.
HTML. Универсальные атрибуты тегов.
HTML. Изображения, рисунки и мультимедиа.
HTML. Формы и поля ввода.
HTML. DOM. Дерево элементов. Основные понятия.
CSS. Понятие таблицы стилей, назначение, общая характеристика языка.
Способы подключения стилей к веб-страницы. Как выбрать правильный?
CSS. Селекторы. Виды селекторов.
CSS. Задание цвета элементов. Способы задания цветов.
CSS. Задание параметров шрифтов.
CSS. Задание параметров границ элементов.
CSS. Задание размеров блочных элементов.
CSS. Задание внутренних и внешних отступов блочных элементов.
CSS. Единицы измерения размеров. Преимущества и недостатки.
CSS. Выравнивание и позиционирование блочных элементов.
CSS. Способы позиционирования блочных элементов.
CSS. Псевдоклассы и псевдоэлементы.
CSS. Каскадность, наследование, приоритеты стилей.
CSS. Адаптивная верстка.
CSS. Flexbox. Основные понятия, структура, примеры свойств.
CSS. Grid. Основные понятия, структура, примеры свойств.
CSS. Препроцессоры: основные понятия, назначение, примеры кода на SASS или LESS.
Понятие CSS-фреймворков. Примеры, сравнение, назначение.
Bootstrap. назначение, общая характеристика, примеры работы.
Общая характеристика языка программирования JavaScript.
Клиентский JavaScript. Схема работы, назначение, примеры, способы связывания.
JavaScript. Инструкции, комментарии, объявление переменных.
JavaScript. Простые типы данных.
JavaScript. Базовые математические и логические операторы.
JavaScript. Операции со строками.
JavaScript. Массивы. Создание, использование, основные операции.
JavaScript. Условные операторы.
JavaScript. Операторы циклов.
JavaScript. Функции.
JavaScript. Обработка исключений.
JavaScript. Литерация объектов. JSON.
JavaScript. Классы в ES6. 
JavaScript. Функции высших порядков.
JavaScript. Наследование.
JavaScript. Деструктуризация массивов и объектов.
JavaScript. Стрелочные функции.
JavaScript. Промисы.
DOM. Браузерное окружение в JavaScript.
DOM. Навигация. Способы нахождения элементов. Поиск по дереву.
DOM. Свойства узлов. Изменение свойств элементов.
DOM. Браузерные события. Обработчики событий.
DOM. Методы обхода дерева элементов.
DOM. Программное создание нового элемента и добавление его в дерево.
